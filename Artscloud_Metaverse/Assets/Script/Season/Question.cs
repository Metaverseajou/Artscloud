...
public class Question : MonoBehaviour
{
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        else if (other.gameObject.CompareTag("Summer1"))
        {
            ...
            Answer.transform.GetChild(2).gameObject.SetActive(false);

        }
        else if (other.gameObject.CompareTag("Summer2"))
        {
            Debug.Log("여름 사운드 퇴장");
            Quest.transform.GetChild(3).gameObject.SetActive(false);
            Answer.transform.GetChild(3).gameObject.SetActive(false);
        ...
        {
            Debug.Log("가을 이미지 퇴장");
            Quest.transform.GetChild(4).gameObject.SetActive(false);
            Answer.transform.GetChild(4).gameObject.SetActive(false);

        }
        else if (other.gameObject.CompareTag("Fall2"))
        {
            Debug.Log("가을 사운드 퇴장");
            Quest.transform.GetChild(5).gameObject.SetActive(false);
            Answer.transform.GetChild(5).gameObject.SetActive(false);
        ...
        {
            Debug.Log("겨울 이미지 퇴장");
            Quest.transform.GetChild(6).gameObject.SetActive(false);
            Answer.transform.GetChild(6).gameObject.SetActive(false);
        ...
        {
            Debug.Log("겨울 사운드 퇴장");
            Quest.transform.GetChild(7).gameObject.SetActive(false);
            Answer.transform.GetChild(7).gameObject.SetActive(false);
